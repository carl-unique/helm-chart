...
```bash
helm install cryptpad oci://ghcr.io/cryptpad/helm/cryptpad --version 0.0.24
```
...
helm install cryptpad cryptpad-github/cryptpad --version 0.0.24
```
cd
## Signing
...
```bash
  ...
  helm fetch --verify cryptpad-github/cryptpad --version 0.0.24 --keyring helm-charts.gpg
```
